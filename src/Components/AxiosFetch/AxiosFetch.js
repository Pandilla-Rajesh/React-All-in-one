...
<div className='col-auto px-2 py-5'>
    <h2 className='text-5xl font-bold text-gray-100 dark:text-white text-yellow-50'>Welcome Axios and Fetch API Call</h2>
</div>
...
<div className='col-auto'>
    ...
    <div className='bg-white rounded-lg p-4 shadow-lg hover:shadow-lg transition-xl'>
        <div className=' flex items-center justify-center flex-wrap flex-col'>
            <div className='py-6'> 
                <h3 className='text-3xl font-bold'>React Axios API Calls</h3></div>
            <div className='table-responsive'>
                ...
                <div>
                    <button onClick={postHandle} className='btn btn-primary border-t-neutral-800'>PostData</button>
                </div>
            </div>
        </div>
    </div>
